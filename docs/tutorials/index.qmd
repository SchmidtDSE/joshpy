...
- Load a `GridSpec` for grid geometry and data files
...
### [Multi-Session Experiments](multi-session-experiments.qmd)

Track labeled ad-hoc runs across sessions with `ProjectCatalog`:

- Accumulate runs in a shared registry across sessions
- Find past registries via the catalog
- Compare labeled runs with `group_by="label"`

Best for: Iterative research where you tweak and compare across days.
