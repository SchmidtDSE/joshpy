...
### [JAR Management](jar-management.qmd)

Switch between production, development, and custom JAR files:

- `JarMode` enum for quick mode selection
- `JarManager` for fine-grained control
- Version tracking for reproducibility

Best for: Managing Josh runtime versions across environments.

### [Remote Execution](remote-execution.qmd)

Run simulations on Josh Cloud or local servers:

- Toggle between local and remote execution
- API key management with environment variables
- Comparison of execution modes

Best for: Scaling up to distributed compute for large sweeps.
...
4. [JAR Management](jar-management.qmd) - manage Josh runtime versions
5. [Remote Execution](remote-execution.qmd) - run on Josh Cloud
