...
3. Verifying preprocessed data with `load_jshd()`
...
3. **Verified point values** using `cli.inspect_jshd()` to spot-check coordinates
4. **Visualized the full grid** using `load_jshd()` and `plot_jshd()` to confirm patterns
