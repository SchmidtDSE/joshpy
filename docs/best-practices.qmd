...
1. [DuckDB Schema & Querying](#duckdb-schema-querying-patterns) - Understanding the registry structure
2. [Registry Lifecycle](#registry-lifecycle) - One registry per experiment
3. [Preprocessing & Grid Alignment](#preprocessing-grid-alignment) - When to regenerate JSHD files
4. [Error Diagnosis](#error-diagnosis) - Josh vs. joshpy vs. user responsibility
5. [Additional Best Practices](#additional-best-practices) - Development workflow, templates, performance
