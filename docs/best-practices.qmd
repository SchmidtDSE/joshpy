...
**User responsibility:** Track which source files produced which JSHD files. Consider:

- A preprocessing log file (YAML or JSON)
- Directory naming that encodes grid parameters
- Re-preprocessing when in doubt

### Directory Organization

Organize preprocessed data by grid definition:
...
│       └── climate_rcp85.jshd
│
└── preprocessing_log.yaml        # Track what was preprocessed how
```

Example `preprocessing_log.yaml`:

```yaml
grid_1km_socal:
  grid_size: 1000m
  bounds: "33.7-34.0 lat, -116.4 to -115.4 lon"
  crs: EPSG:4326
  files:
    climate_rcp45.jshd:
      source: raw/climate_rcp45.nc
      variable: temperature
      units: K
      preprocessed: 2024-01-15
    climate_rcp85.jshd:
      source: raw/climate_rcp85.nc
      variable: temperature
      units: K
      preprocessed: 2024-01-15
```
